        ...
        <View style={styles.servicesContainer}>
          ...
          <View style={styles.servicesGrid}>
            ...
            >
              ...
              <Text style={styles.serviceTitle}>Regular Wash</Text>
              <Text style={styles.servicePrice}>From {formatCurrency(5.99)}/kg</Text>
            </TouchableOpacity>
            ...
            >
              ...
              <Text style={styles.servicePrice}>From {formatCurrency(9.99)}/item</Text>
            </TouchableOpacity>
            ...
            >
              ...
              <Text style={styles.serviceTitle}>Express</Text>
              <Text style={styles.servicePrice}>From {formatCurrency(12.99)}/kg</Text>
            </TouchableOpacity>
          </View>
        </View>
              ...
              >
                ...
                <View style={styles.orderDetails}>
                  <View>
                    ...
                    <Text style={styles.orderWeight}>{order.weight_estimate} kg</Text>
                  </View>
                  <View style={styles.orderPriceContainer}>
                    <Text style={styles.orderPrice}>{formatCurrency(order.total_cost)}</Text>
