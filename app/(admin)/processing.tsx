...
import { ArrowRight, Package, ArrowLeft } from "lucide-react-native";
...
export default function ProcessingOrdersScreen() {
  ...
  // Debug logging
  useEffect(() => {
    console.log("ProcessingOrdersScreen mounted");
    return () => {
      console.log("ProcessingOrdersScreen unmounted");
    };
  }, []);
  ...
  const fetchOrders = async () => {
    ...
    try {
      ...
      console.log(`Fetched ${data?.length || 0} processing orders`);
            ...
            onPress={() => {
              Alert.alert(
                ...
                [
                  ...
                  { text: "Update", onPress: () => updateOrderStatus(String(item.id), "ready") }
                ]
              );
            }}
          >
  ...
  const renderEmptyList = () => (
    <View style={styles.emptyContainer}>
      <Text style={styles.emptyText}>No processing orders found</Text>
    </View>
  );
  ...
  return (
    <SafeAreaView style={styles.container} edges={["top"]}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Processing Orders</Text>
